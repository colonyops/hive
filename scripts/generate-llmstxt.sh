...
NAV=(
  ...
  "Configuration|configuration/index.md|Configuration|Config file, rules, templates, and options"
  "Configuration|configuration/commands.md|Commands & Keybindings|User commands, command palette, and keybindings"
  "Configuration|configuration/plugins.md|Plugins|Claude, tmux, and other plugin configuration"
