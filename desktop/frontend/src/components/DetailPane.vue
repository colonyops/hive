...
<template>
  <aside class="hive-scroll flex w-[466px] shrink-0 flex-col overflow-y-auto bg-pane">
    <template v-if="item">
...
<style scoped>
.source-icon { display: inline-flex; align-items: center; justify-content: center; width: 18px; height: 18px; border: 1px solid var(--color-strong); border-radius: 5px; background: var(--color-chip); color: #e4e4e7; font-family: var(--font-mono); font-size: 8px; font-weight: 700; }
...
.open-button:hover, .edit-button:hover { border-color: #3a3a40; color: var(--color-text); }
</style>
