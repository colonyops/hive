...
<template>
  <aside class="flex w-[58px] shrink-0 flex-col items-center gap-2.5 border-r border-border bg-raised py-3">
    ...
    <button class="flex size-[38px] cursor-default items-center justify-center rounded-[10px] border border-dashed border-card text-xl text-text-4 hover:border-[#3a3a40] hover:text-text-2" aria-label="Add profile">+</button>
    <div class="flex-1" />
    <span class="flex size-[38px] items-center justify-center text-base text-text-4">◔</span>
    <span class="flex size-[30px] items-center justify-center rounded-full bg-[#3a2f18] font-mono text-xs font-semibold text-accent">hy</span>
  </aside>
</template>
