...
var defaultViewsConfig = ViewsConfig{
	...
	Tasks: TasksViewConfig{
		Keybindings: map[string]Keybinding{
			...
			"o": {Cmd: "TasksSetOpen", Help: "set open"},
			"i": {Cmd: "TasksSetInProgress", Help: "set in progress"},
			"d": {Cmd: "TasksSetDone", Help: "set done"},
			"x": {Cmd: "TasksSetCancelled", Help: "set cancelled"},
			"D": {Cmd: "TasksDelete", Help: "delete"},
			"P": {Cmd: "TasksPrune", Help: "prune done"},
		},
	},
}
